...
export default function HomeMap() {
  ...
  // Posts filtrados según la búsqueda
  ...
  // Cuando cambia el filtro, si el post seleccionado ya no está en los resultados, lo deseleccionamos
  useEffect(() => {
